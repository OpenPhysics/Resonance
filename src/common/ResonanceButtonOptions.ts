...
export const LIGHT_SURFACE_TEXT_FILL = ResonanceColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link ResonanceColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: ResonanceColors.controlSurfaceColorProperty,
  listFill: ResonanceColors.controlSurfaceColorProperty,
  buttonStroke: ResonanceColors.panelBorderColorProperty,
  listStroke: ResonanceColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: ResonanceColors.textColorProperty },
  },
